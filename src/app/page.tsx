      ...
      <div className="text-zinc-900 mt-20 text-md">
        ...
        <section className="mt-8">
          ...
          <p className="mt-2">
            ...
            defined ways of doing things, great docs and examples and community.
        ...
        <section className="mt-8">
          ...
          <p className="mt-2">
            ...
            work with React context and reducers and in my experience they
            don&apos;t scale that well in large projects. It easily becomes a
            mess of dependencies and as they slowly creep higher in the app tree
            you can easily introduce larger and larger rerenders.
          </p>
          <p className="mt-2">
            As the current state is more of a &quot;backend state&quot; I feel a
            better option would have been something like a React query or to use
            server actions. Probably an interesting discussion in the context of
        ...
        <section className="mt-8">
          ...
          <p className="mt-2">
            ...
            flexible. I find some of the error typings a bit strange but
            that&apos;s life :)
          </p>
          <p className="mt-2">
        ...
        <section className="mt-8">
          ...
          <p className="mt-2">
            In hindsight I could have specified what does this mean to you?
            There are many factors like planning, scalability, security,
            reliability, compliance, flexibility. I decided to focus on topics I
            personally feel quite critical when managing a large and long living
            application.
          </p>
          <p className="mt-2">
